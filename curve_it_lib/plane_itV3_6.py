...
def run_processing(args: argparse.Namespace) -> str:
    ...
    write_projection_svg(output_svg, args, atom_types, selected_atoms, projection, styles, base_pair_drawables, all_atoms=all_atoms)
    write_projection_json(output_json, args, atom_types, selected_atoms, projection, hull_area, output_svg, output_csv, output_pdb, styles, base_pair_info)
    if output_csv is not None:
    ...
    return format_summary(args, atom_types, selected_atoms, projection, output_svg, output_json, output_csv, output_pdb, n_transformed, styles, base_pair_info)
